...
- invents a different v1.0.0 installer SHA-256 than the published desktop knowledge pack
...
2. **Trademark.** Retain a U.S. trademark attorney; complete a comprehensive search; file only in the name of the actual owner (today: Soul Consciousness Studios personally). See [TRADEMARK_FILING.md](TRADEMARK_FILING.md). Use ™ until a registration **issues**.
