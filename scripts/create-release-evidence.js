...
const privacy = { schemaVersion: 1, product: 'Eidovara', version: pkg.version, declarationType: 'self-declared-and-build-attested', telemetry: false, advertising: false, automaticExternalSafetyReporting: false, localConversationStorage: true, secretsExposedToRenderer: false, updater: { automaticCheck: true, downloadRequiresUserApproval: true, httpsRequired: true, sha256Required: true }, documents: ['PRIVACY.md', 'TERMS.md', 'AGE.md', 'SECURITY.md', 'LEGAL_NOTICES.md', 'docs/NETWORK_USAGE.md'] };
