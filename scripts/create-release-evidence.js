...
const names = fs.readdirSync('dist').filter(name => /\.(?:exe|zip|json)$/i.test(name) && (name.startsWith('Project-Soul-Studios-') || name === 'update.json')).sort();
