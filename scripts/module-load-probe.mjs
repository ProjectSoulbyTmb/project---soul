...
const modules = [
  ...
  'src/core/desktop-chrome.js',
  'src/core/media-protocol.js',
  'src/core/now-playing.js',
  'src/core/overlays.js',
  'src/core/log-redact.js',
  'src/core/runtime-engines.js',
  'src/core/service.js',
  'src/core/soul-online.js',
  'src/core/updater.js',
  'src/core/release.js',
  'src/core/bounded-read.js',
  'src/core/guards/index.js',
  'src/providers/offline.js',
  'src/providers/http.js',
  'src/providers/internet.js',
  'src/providers/context.js',
  'src/config/release-channel.js',
];
let ok = 0;
let failed = 0;
for (const m of modules) {
  try {
    ...
    console.error('FAIL ' + m + ' :: ' + String(e.message || e).slice(0, 120));
    failed++;
  }
}
