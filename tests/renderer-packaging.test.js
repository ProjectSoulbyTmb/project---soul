...
test('packaged startup loads and validates the explicit renderer entry', () => {
  matchTolerant(main, /process\.resourcesPath, 'renderer', 'index\.html'/);
  matchTolerant(main, /app\.isPackaged \? packagedRenderer/);
  matchTolerant(main, /Renderer entry is missing/);
