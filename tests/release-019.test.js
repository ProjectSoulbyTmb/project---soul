...
test('v0.19.2 keeps kernel, official api.eidovara.org, and honest 18+ truth', () => {
  assert.equal(JSON.parse(read('package.json')).version, '0.19.2');
  assert.equal(DESKTOP_KNOWLEDGE_VERSION, '0.19.2');
