...
test('historical release hashes stay in CHANGELOG; live pages advertise only the current installer', () => {
  ...
  matchTolerant(v0190, /F2B0D9BB0A887294CF58A43C75DF67FA422C2120540DE03D5227A9B239D08310/);
  ...
  matchTolerant(read('src/providers/internet.js'), /RAW_DROP_TAGS/);
  matchTolerant(read('tests/internet.test.js'), /<SCRIPT>steal\(\)<\/SCRIPT>/);
  assert.doesNotMatch(
