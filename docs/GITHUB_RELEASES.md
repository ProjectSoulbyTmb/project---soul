...
4. Until a real `Eidovara-0.19.1-Windows-x64-Setup.exe` exists, keep the public site primary download on the live hashed `v0.19.0` asset: `https://github.com/ProjectSoulbyTmb/project---soul/releases/latest/download/Eidovara-0.19.0-Windows-x64-Setup.exe`. Keep `/releases/latest` as a checksums/notes link. Do not make the GitHub source tree the main download button. Independently hashed SHA-256: `F2B0D9BB0A887294CF58A43C75DF67FA422C2120540DE03D5227A9B239D08310` (106263840 bytes). **Do not** move tags `v0.18.0`, `v0.18.1`, `v0.18.2`, `v0.18.3`, or `v0.19.0`. After this updater merge, tag **`v0.19.1`**. Upload `latest.yml` and `*.blockmap` on that tagged Windows job.
