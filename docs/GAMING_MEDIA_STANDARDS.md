...
- Audio/video playback uses the codecs available to the packaged Chromium runtime and operating system. Unsupported formats fail visibly; Eidovara does not bundle unlicensed codec packs or protected-media circumvention. The in-app player is for local `eidovara-media:` files and allowlisted public HTTPS media; Spotify and YouTube remain official browser searches.
