...
export const ENTRIES = [
  ...
  },
  {
    ...
    links: [{ href: 'help.html', label: 'Help' }, { href: 'status.html', label: 'Status' }]
  },
  {
    id: 'offline',
    modes: ['help'],
  ...
  },
  {
    ...
    links: [{ href: 'assist.html', label: 'Assist' }, { href: 'help.html', label: 'Help / FAQ' }]
  },
  {
    id: 'status',
    modes: ['help'],
...
export function answerAssist(raw, options = {}) {
  ...
  if (!classified.ok) {
    return {
      ...
      links: [{ href: 'help.html', label: 'Help / FAQ' }, { href: 'terms.html', label: 'Terms' }]
    };
  }
  ...
  const reply = weak
    ...
    : `${preface}${best.reply}`;
  const links = weak
    ? [{ href: 'help.html', label: 'Help / FAQ' }, { href: 'download.html', label: 'Download' }, { href: 'legal.html', label: 'Legal' }]
    : (best.links || []).slice();
  return {
    ok: true,
