...
export const ENTRIES = [
  ...
  },
  {
    ...
    reply:
      'Eidovara, Soul, and the Soul kernel are first-party software names. Third-party products, platforms, models, media services, and marks remain owned by their respective owners. Eidovara is not Jarvis and is not affiliated with those owners. References to interoperable services are factual platform or user-directed handoff information and do not imply sponsorship or affiliation.',
    links: [
  ...
  },
  {
    ...
    reply:
      'Contributor and entity assignment documents in the public repository are templates unless separately executed. Pull requests do not transfer copyright or trademark rights by themselves. Do not publish executed private agreements or confidential material in the repository.',
    links: [
