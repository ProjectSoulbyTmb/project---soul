...
export const ENTRIES = [
  ...
  },
  {
    ...
    reply: `The official download is ${INSTALLER_NAME}, an Authenticode-unsigned Windows 10/11 x64 NSIS installer from GitHub Releases. Size: size listed with the release assets. SHA-256: published in SHA256SUMS.txt. Latest alias: ${INSTALLER}. Pinned asset: ${INSTALLER_PINNED}. Eidovara is an unregistered trademark of Soul Consciousness Studios. Windows SmartScreen may warn. GitHub/Sigstore provenance records build origin but is not Authenticode signing.`,
    links: [
  ...
  },
  {
    ...
    reply:
      'The repository uses the Eidovara Source-Available Evaluation License (LicenseRef-Eidovara-Source-Available-1.0). It is not an OSI open-source license. Eidovara is a trademark of Soul Consciousness Studios (unregistered), and viewing or forking the source does not transfer ownership or grant patent/trademark rights. Read LICENSE, TERMS, NOTICE, OWNERSHIP, TRADEMARKS, and AGE with the release.',
    links: [
      { href: 'licensing.html', label: 'Licensing' },
  ...
  },
  {
    ...
    reply:
      'Contributor and entity assignment documents in the public repository are unsigned templates unless separately executed. Posting a pull request does not by itself transfer copyright or trademark rights. Do not publish executed private agreements or confidential material in the repository. Contributors do not transfer copyright merely by opening a pull request.',
    links: [
  ...
  },
  {
    ...
    title: 'Public status',
    reply: `Public surfaces are ${SITE}, the GitHub Pages mirror, and the official Windows release on GitHub Releases (${INSTALLER_NAME}, size listed with the release assets, SHA-256 published in SHA256SUMS.txt). The Status page uses https://api.eidovara.org by default for health/status. Invalid URLs fail closed.`,
    links: [
      { href: 'status.html', label: 'Status' },
