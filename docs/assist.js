...
function mount() {
  ...
  const sub = el('p', { className: 'assist-sub', text: 'Ask Eidovara answers from a fixed v0.18.3 knowledge pack. Not Soul, not conscious, not legal advice. Adults 18+.' });
  ...
  addMessage(log, 'assistant', 'I am a website helper for Eidovara v0.18.3, not Soul. Ask about the Windows desktop app, download, age 18+, payments, or legal pointers. Conversations are not stored.');
