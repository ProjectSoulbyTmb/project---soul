...
| 2026-08-22 | Public main history force-squashed into a single snapshot commit; SUPPORT.md dropped in the rewrite | Racing sessions + forbidden force-update (AGENTS.md 1.4) | Fetch diff during scheduled verification | Branch protection ruleset on main (4.4); single-writer rule (1.1) |
