...
| Spotify, YouTube, or Netflix HTTPS search | You click those media buttons or confirm a catalog URL | Current track search text or the official page URL; the destination site may set its own cookies |
| User-initiated public HTTPS audio/video file | You enable **Online media** and ask to play a specific HTTPS file (Entertainment field, “play this https …”, or Play on a Wikimedia/Archive file URL) | The media URL, IP address, application user agent. No cookies. Redirects capped. Not a page scrape. |
