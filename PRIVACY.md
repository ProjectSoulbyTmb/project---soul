...
| Spotify or YouTube HTTPS page | You open the isolated online viewing window or click those media buttons | Search text or page URL; the destination site may set cookies in the guest partition only. The workspace renderer does not load those sites. |
