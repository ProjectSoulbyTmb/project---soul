# Project Soul Studios HTTPS service
...
6. Copy the resulting `https://project-soul-studios-api.<account>.workers.dev` URL into Soul's private Ctrl+A administration panel.
