...
Operator example (not baked into the app or public site): `https://eidovara-api.dreambot333.workers.dev` currently serves `/health`, `/v1/config`, `/v1/status`, and `/v1/assist` on Workers Free after you re-deploy. The official website is `https://eidovara.org/` (Cloudflare Pages). GitHub Pages mirror: `https://projectsoulbytmb.github.io/project---soul/`.
