...
(() => {
  const messages = {
    en: {
      ...
      overlayTitle: 'Workspace overlays', overlayLead: 'Floating Eidovara windows for Soul chat, HTTPS browsing, and Discord’s own website. Not an official Discord overlay. Does not inject into other games. Assist never receives Discord tokens.',
      ...
      overlayHelp: 'Overlays are Eidovara windows. Discord is their website in a sandboxed guest session — not an official Discord overlay, not affiliated, and not injection into other games. Guest browsing is HTTPS you open. Assist never receives Discord tokens or guest DOM.',
      playDeskTitle: 'Play desk', playDeskLead: 'Confirm-launched library recents, Eidovara overlays, and this process’s CPU/memory. Not a Steam overlay and not other-game telemetry.',
      ...
      recentsTitle: 'Recents', recentsLead: 'Linked apps you confirm-launched, local media titles, and memories you opened — on this PC only.', recentsEmpty: 'Nothing recent yet.',
    ...
    es: {
      ...
      overlayTitle: 'Overlays del espacio', overlayLead: 'Ventanas flotantes de Eidovara para el chat Soul, navegación HTTPS y el propio sitio de Discord. No es un overlay oficial de Discord. No se inyecta en otros juegos. Assist no recibe tokens de Discord.',
      overlayChat: 'Overlay de chat Soul', overlayBrowse: 'Overlay de navegación', overlayDiscord: 'Discord invitado', overlayGo: 'Abrir en overlay de navegación', overlayUrlLabel: 'Dirección HTTPS para el overlay de navegación', overlayKeys: 'Ctrl+Shift+O salta aquí. Ctrl+K también lista overlays. Esc cierra un overlay salvo si escribes en la página invitada.',
      overlayHelp: 'Los overlays son ventanas de Eidovara. Discord es su sitio en una sesión invitada aislada: no es un overlay oficial, no hay afiliación ni inyección en otros juegos. Assist no recibe tokens de Discord ni el DOM invitado.',
      playDeskTitle: 'Mesa de juego', playDeskLead: 'Recientes de apps lanzadas con confirmación, overlays de Eidovara y CPU/memoria de este proceso. No es un overlay de Steam ni telemetría de otros juegos.',
      playRecentsEmpty: 'Lanza con confirmación una app vinculada para verla aquí. Eidovara no inspecciona otros juegos.',
      overlayRecentsEmpty: 'Las páginas HTTPS que abras en el overlay de navegación aparecen aquí. Solo local.',
      overlayMetricsRefresh: 'Actualizar métricas del proceso Eidovara', overlayMetricsOff: 'Métricas de proceso no disponibles en esta sesión.',
      shortcutOverlays: 'Saltar a overlays del espacio (chat, navegación, Discord invitado). Solo en la app.',
      ...
      recentsTitle: 'Recientes', recentsLead: 'Apps que abriste con confirmación, títulos de medios locales y recuerdos — solo en este PC.', recentsEmpty: 'Aún no hay recientes.',
      notifyTitle: 'Avisos en la app', notifyLead: 'Eventos locales de este espacio. No es spam del sistema ni telemetría.', notifyClear: 'Borrar', notifyEmpty: 'Aún no hay avisos.',
      sleepTimer: 'Temporizador de apagado', sleepOff: 'Off', sleep15: '15 min', sleep30: '30 min', sleep60: '60 min',
      nowPlaying: 'Reproduciendo', trayStay: 'Seguir en la bandeja', alwaysOnTop: 'Mantener ventana al frente', openAtLogin: 'Abrir al iniciar Windows', pinCompanion: 'Fijar el compañero', chromeHelp: 'Bandeja, siempre visible e inicio aplican solo a esta ventana de Eidovara.',
    ...
    fr: {
      ...
      overlayTitle: 'Overlays de l’espace', overlayLead: 'Fenêtres flottantes Eidovara pour le chat Soul, la navigation HTTPS et le site Discord. Pas un overlay Discord officiel. Pas d’injection dans d’autres jeux. Assist ne reçoit pas de jetons Discord.',
      overlayChat: 'Overlay chat Soul', overlayBrowse: 'Overlay navigation', overlayDiscord: 'Discord invité', overlayGo: 'Ouvrir dans l’overlay navigation', overlayUrlLabel: 'Adresse HTTPS pour l’overlay navigation', overlayKeys: 'Ctrl+Shift+O saute ici. Ctrl+K liste aussi les overlays. Échap ferme un overlay sauf si vous tapez dans la page invitée.',
      overlayHelp: 'Les overlays sont des fenêtres Eidovara. Discord est leur site dans une session invitée isolée — pas un overlay officiel, pas d’affiliation, pas d’injection dans d’autres jeux. Assist ne reçoit jamais de jetons Discord ni le DOM invité.',
      playDeskTitle: 'Bureau Play', playDeskLead: 'Récents d’apps lancées avec confirmation, overlays Eidovara, et CPU/mémoire de ce processus. Pas un overlay Steam, pas de télémétrie d’autres jeux.',
      playRecentsEmpty: 'Lancez avec confirmation une app liée pour la voir ici. Eidovara n’inspecte pas d’autres jeux.',
      overlayRecentsEmpty: 'Les pages HTTPS ouvertes dans l’overlay navigation apparaissent ici. Local seulement.',
      overlayMetricsRefresh: 'Actualiser les métriques du processus Eidovara', overlayMetricsOff: 'Métriques de processus indisponibles dans cette session.',
      shortcutOverlays: 'Aller aux overlays (chat, navigation, Discord invité). Dans l’app seulement.',
      ...
      recentsTitle: 'Récents', recentsLead: 'Apps lancées avec confirmation, titres de médias locaux et souvenirs — sur cet appareil seulement.', recentsEmpty: 'Rien de récent.',
      notifyTitle: 'Avis dans l’app', notifyLead: 'Événements locaux de cet espace. Pas de toasts OS ni de télémétrie.', notifyClear: 'Effacer', notifyEmpty: 'Aucun avis.',
      sleepTimer: 'Minuteur sommeil', sleepOff: 'Off', sleep15: '15 min', sleep30: '30 min', sleep60: '60 min',
      nowPlaying: 'Lecture en cours', trayStay: 'Rester dans la zone de notification', alwaysOnTop: 'Garder la fenêtre au premier plan', openAtLogin: 'Ouvrir à la connexion Windows', pinCompanion: 'Épingler le compagnon', chromeHelp: 'Zone de notification, premier plan et ouverture à la connexion s’appliquent uniquement à Eidovara.',
    ...
    de: {
      ...
      overlayTitle: 'Workspace-Overlays', overlayLead: 'Schwebende Eidovara-Fenster für Soul-Chat, HTTPS-Browsing und Discords eigene Website. Kein offizielles Discord-Overlay. Keine Injektion in andere Spiele. Assist erhält keine Discord-Tokens.',
      overlayChat: 'Soul-Chat-Overlay', overlayBrowse: 'Browse-Overlay', overlayDiscord: 'Discord-Gast', overlayGo: 'Im Browse-Overlay öffnen', overlayUrlLabel: 'HTTPS-Adresse für das Browse-Overlay', overlayKeys: 'Strg+Umschalt+O springt hierher. Strg+K listet Overlays ebenfalls. Esc schließt ein Overlay, außer Sie tippen in der Gastseite.',
      overlayHelp: 'Overlays sind Eidovara-Fenster. Discord ist deren Website in einer isolierten Gastsitzung — kein offizielles Discord-Overlay, keine Affiliation, keine Injektion in andere Spiele. Assist erhält keine Discord-Tokens und kein Gast-DOM.',
      playDeskTitle: 'Play-Pult', playDeskLead: 'Zuletzt bestätigt gestartete Apps, Eidovara-Overlays und CPU/Speicher dieses Prozesses. Kein Steam-Overlay und keine Telemetrie anderer Spiele.',
      playRecentsEmpty: 'Starten Sie eine verknüpfte App mit Bestätigung, damit sie hier erscheint. Eidovara liest keine anderen Spiele.',
      overlayRecentsEmpty: 'HTTPS-Seiten, die Sie im Browse-Overlay öffnen, erscheinen hier. Nur lokal.',
      overlayMetricsRefresh: 'Eidovara-Prozessmetriken aktualisieren', overlayMetricsOff: 'Prozessmetriken in dieser Sitzung nicht verfügbar.',
      ...
      recentsTitle: 'Zuletzt', recentsLead: 'Bestätigt gestartete Apps, lokale Medientitel und Erinnerungen — nur auf diesem PC.', recentsEmpty: 'Noch nichts zuletzt.',
      ...
      nowPlaying: 'Gerade läuft', trayStay: 'Im Infobereich weiterlaufen', alwaysOnTop: 'Fenster im Vordergrund', openAtLogin: 'Bei Windows-Anmeldung öffnen', pinCompanion: 'Begleiter anheften', chromeHelp: 'Infobereich, Immer im Vordergrund und Anmeldung gelten nur für dieses Eidovara-Fenster.',
