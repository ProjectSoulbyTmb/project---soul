...
(() => {
  const messages = {
    en: {
      ...
      overlayChat: 'Soul chat overlay', overlayBrowse: 'Browse overlay', overlayDiscord: 'Discord guest', overlayGo: 'Open in browse overlay', overlayUrlLabel: 'HTTPS address for the browse overlay', overlayKeys: 'Ctrl+Shift+O jumps here. Ctrl+K also lists overlays.',
    ...
    es: {
      ...
      overlayChat: 'Overlay de chat Soul', overlayBrowse: 'Overlay de navegación', overlayDiscord: 'Discord invitado', overlayGo: 'Abrir en overlay de navegación', overlayUrlLabel: 'Dirección HTTPS para el overlay de navegación', overlayKeys: 'Ctrl+Shift+O salta aquí. Ctrl+K también lista overlays.',
    ...
    fr: {
      ...
      overlayChat: 'Overlay chat Soul', overlayBrowse: 'Overlay navigation', overlayDiscord: 'Discord invité', overlayGo: 'Ouvrir dans l’overlay navigation', overlayUrlLabel: 'Adresse HTTPS pour l’overlay navigation', overlayKeys: 'Ctrl+Shift+O saute ici. Ctrl+K liste aussi les overlays.',
    ...
    de: {
      ...
      overlayChat: 'Soul-Chat-Overlay', overlayBrowse: 'Browse-Overlay', overlayDiscord: 'Discord-Gast', overlayGo: 'Im Browse-Overlay öffnen', overlayUrlLabel: 'HTTPS-Adresse für das Browse-Overlay', overlayKeys: 'Strg+Umschalt+O springt hierher. Strg+K listet Overlays ebenfalls.',
