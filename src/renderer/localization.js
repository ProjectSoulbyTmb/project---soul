...
(() => {
  const messages = {
    en: {
      ...
      entertainmentTitle: 'Entertainment', entertainmentLead: 'Local files play at native quality. Optional Online media plays public HTTPS audio/video you ask for. Spotify, YouTube, and Netflix open in your browser.',
      ...
      platformTitle: 'Platform connections', platformLead: 'Spotify, YouTube, and Netflix open official searches in your system browser. Eidovara does not capture credentials, bypass subscriptions, download protected streams, or imply affiliation.',
      openLocalMedia: 'Open local media', playOnline: 'Play HTTPS file',
      ...
      playerNothing: 'Nothing playing', playerNative: 'Native', playerStream: 'Stream', playerLyrics: 'No licensed lyrics in-app',
      playerBlockedSrc: 'That source cannot play in Eidovara. Use a local file or a public HTTPS file. Spotify, YouTube, and Netflix stay in the browser.',
    ...
    es: {
      ...
      openLocalMedia: 'Abrir medio local', playOnline: 'Reproducir archivo HTTPS',
      ...
      catalogHandoff: 'Este servicio no puede reproducirse dentro de Eidovara; se abre en tu navegador.',
      playerNothing: 'Nada en reproducción', playerNative: 'Nativo', playerStream: 'Flujo', playerLyrics: 'Sin letras con licencia en la app',
      playerBlockedSrc: 'Esa fuente no puede reproducirse en Eidovara. Usa un archivo local o un archivo HTTPS público. Spotify, YouTube y Netflix siguen en el navegador.',
    ...
    fr: {
      ...
      openLocalMedia: 'Ouvrir un média local', playOnline: 'Lire un fichier HTTPS',
      ...
      catalogHandoff: 'Ce service ne peut pas être lu dans Eidovara ; il s’ouvre dans votre navigateur.',
      playerNothing: 'Rien en lecture', playerNative: 'Natif', playerStream: 'Flux', playerLyrics: 'Pas de paroles sous licence dans l’app',
      playerBlockedSrc: 'Cette source ne peut pas être lue dans Eidovara. Utilisez un fichier local ou un fichier HTTPS public. Spotify, YouTube et Netflix restent dans le navigateur.',
    ...
    de: {
      ...
      openLocalMedia: 'Lokale Medien öffnen', playOnline: 'HTTPS-Datei abspielen',
      ...
      catalogHandoff: 'Dieser Dienst kann nicht in Eidovara wiedergegeben werden; er öffnet sich im Browser.',
      playerNothing: 'Nichts wird wiedergegeben', playerNative: 'Nativ', playerStream: 'Stream', playerLyrics: 'Keine lizenzierten Songtexte in der App',
      playerBlockedSrc: 'Diese Quelle kann in Eidovara nicht wiedergegeben werden. Nutzen Sie eine lokale Datei oder eine öffentliche HTTPS-Datei. Spotify, YouTube und Netflix bleiben im Browser.',
  ...
  queueMicrotask(async () => {
    try {
      ...
      select.addEventListener('change', async () => {
        ...
        await window.soul.configureAssistant({ autonomy: state.assistant?.autonomy, initiativeEnabled: state.assistant?.initiativeEnabled, reflectionEnabled: state.assistant?.reflectionEnabled, responseLength: p.responseLength, tone: p.tone, focusMode: p.focusMode, accessibility: p.accessibility, language: select.value, webResearch: c.webResearch, mediaPlayback: c.mediaPlayback, onlineMedia: c.onlineMedia, memoryLearning: c.memoryLearning });
      });
    } catch {}
  });
})();
