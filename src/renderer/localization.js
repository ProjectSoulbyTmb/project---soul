...
(() => {
  const messages = {
    en: {
      ...
      entertainmentTitle: 'Entertainment', entertainmentLead: 'Local files play in the Eidovara now-playing bar (expand for video). Spotify, YouTube, and Internet Archive stay official HTTPS searches in the browser — they are not played in-app.',
      ...
      platformTitle: 'Platform connections', platformLead: 'Spotify, YouTube, and Internet Archive buttons confirm, then open official searches in your system browser. Opens in the browser. Eidovara does not capture credentials, bypass subscriptions, download protected streams, embed those players, or imply affiliation.',
      sessionLibrary: 'This session’s local library', discoveryTitle: 'Last discovery', playInEidovara: 'Play in Eidovara', playLocal: 'Play', emptyLibrary: 'Open a local audio or video file to play it in Eidovara. Paths stay out of taste records.', emptyDiscovery: 'Ask for music, a watch, or a mood mix to show local matches and official YouTube/Spotify/Archive search chips.',
      openLocalMedia: 'Open local media',
      playerStageTitle: 'Eidovara player', playerCollapse: 'Collapse player', playerExpand: 'Expand player',
      playerSeek: 'Seek', playerVolume: 'Volume', playerPlay: 'Play', playerPause: 'Pause', playerNothing: 'Nothing playing',
      playerQueue: 'Up next', playerRecents: 'Recent on this device', playerLyricsHeading: 'Lyrics',
      playerLyrics: 'No licensed lyrics in-app', playerLocalFile: 'Local file', playerLocalVideo: 'Local video',
      playerVideo: 'Video', playerAudio: 'Audio', playerSpotify: 'Spotify search', playerYouTube: 'YouTube search',
      playerHandoffConfirm: 'Opens in the browser. Eidovara does not play Spotify or YouTube in-app.',
      playerBlockedSrc: 'That source cannot play in Eidovara. Use a local file or a public HTTPS source. Spotify and YouTube stay browser searches.',
      companionNowPlaying: 'Now playing', companionPause: 'Pause',
    ...
    es: {
      ...
      entertainmentTitle: 'Entretenimiento', entertainmentLead: 'Los archivos locales se reproducen en la barra de Eidovara (expanda para vídeo). Spotify, YouTube e Internet Archive siguen siendo búsquedas HTTPS oficiales en el navegador; no se reproducen dentro de la app.',
      ...
      platformTitle: 'Conexiones de plataforma', platformLead: 'Los botones de Spotify, YouTube e Internet Archive confirman y abren búsquedas oficiales en el navegador. Se abre en el navegador. Eidovara no captura credenciales, evita suscripciones, descarga streams protegidos, incrusta esos reproductores ni implica afiliación.',
      sessionLibrary: 'Biblioteca local de esta sesión', discoveryTitle: 'Último descubrimiento', playInEidovara: 'Reproducir en Eidovara', playLocal: 'Reproducir', emptyLibrary: 'Abra un archivo de audio o vídeo local para reproducirlo en Eidovara. Las rutas no se guardan en el gusto.', emptyDiscovery: 'Pida música, un vídeo o una mezcla para ver coincidencias locales y chips oficiales de YouTube, Spotify o Archive.',
      openLocalMedia: 'Abrir medio local',
      playerStageTitle: 'Reproductor Eidovara', playerCollapse: 'Plegar reproductor', playerExpand: 'Expandir reproductor',
      playerSeek: 'Posición', playerVolume: 'Volumen', playerPlay: 'Reproducir', playerPause: 'Pausa', playerNothing: 'Nada en reproducción',
      playerQueue: 'A continuación', playerRecents: 'Reciente en este dispositivo', playerLyricsHeading: 'Letras',
      playerLyrics: 'No hay letras con licencia en la app', playerLocalFile: 'Archivo local', playerLocalVideo: 'Vídeo local',
      playerVideo: 'Vídeo', playerAudio: 'Audio', playerSpotify: 'Búsqueda de Spotify', playerYouTube: 'Búsqueda de YouTube',
      playerHandoffConfirm: 'Se abre en el navegador. Eidovara no reproduce Spotify ni YouTube dentro de la app.',
      playerBlockedSrc: 'Esa fuente no se puede reproducir en Eidovara. Use un archivo local o una fuente HTTPS pública. Spotify y YouTube siguen siendo búsquedas en el navegador.',
      companionNowPlaying: 'Reproduciendo', companionPause: 'Pausa',
    ...
    fr: {
      ...
      entertainmentTitle: 'Divertissement', entertainmentLead: 'Les fichiers locaux se lisent dans la barre Eidovara (agrandir pour la vidéo). Spotify, YouTube et Internet Archive restent des recherches HTTPS officielles dans le navigateur — pas une lecture in-app.',
      ...
      platformTitle: 'Connexions de plateformes', platformLead: 'Les boutons Spotify, YouTube et Internet Archive confirment, puis ouvrent des recherches officielles dans le navigateur. S’ouvre dans le navigateur. Eidovara ne capture pas les identifiants, n’évite pas les abonnements, ne télécharge pas les flux protégés, n’intègre pas ces lecteurs et n’implique aucune affiliation.',
      sessionLibrary: 'Bibliothèque locale de cette session', discoveryTitle: 'Dernière découverte', playInEidovara: 'Lire dans Eidovara', playLocal: 'Lire', emptyLibrary: 'Ouvrez un fichier audio ou vidéo local pour le lire dans Eidovara. Les chemins restent hors des goûts.', emptyDiscovery: 'Demandez de la musique, une vidéo ou un mix pour voir des correspondances locales et des recherches officielles YouTube/Spotify/Archive.',
      openLocalMedia: 'Ouvrir un média local',
      playerStageTitle: 'Lecteur Eidovara', playerCollapse: 'Réduire le lecteur', playerExpand: 'Agrandir le lecteur',
      playerSeek: 'Position', playerVolume: 'Volume', playerPlay: 'Lecture', playerPause: 'Pause', playerNothing: 'Rien en lecture',
      playerQueue: 'À suivre', playerRecents: 'Récent sur cet appareil', playerLyricsHeading: 'Paroles',
      playerLyrics: 'Pas de paroles licenciées dans l’app', playerLocalFile: 'Fichier local', playerLocalVideo: 'Vidéo locale',
      playerVideo: 'Vidéo', playerAudio: 'Audio', playerSpotify: 'Recherche Spotify', playerYouTube: 'Recherche YouTube',
      playerHandoffConfirm: 'S’ouvre dans le navigateur. Eidovara ne lit pas Spotify ni YouTube dans l’app.',
      playerBlockedSrc: 'Cette source ne peut pas être lue dans Eidovara. Utilisez un fichier local ou une source HTTPS publique. Spotify et YouTube restent des recherches dans le navigateur.',
      companionNowPlaying: 'En lecture', companionPause: 'Pause',
    ...
    de: {
      ...
      entertainmentTitle: 'Unterhaltung', entertainmentLead: 'Lokale Dateien spielen in der Eidovara-Leiste (erweitern für Video). Spotify, YouTube und Internet Archive bleiben offizielle HTTPS-Suchen im Browser — keine Wiedergabe in der App.',
      ...
      platformTitle: 'Plattformverbindungen', platformLead: 'Spotify-, YouTube- und Internet-Archive-Schaltflächen bestätigen und öffnen offizielle Suchen im Systembrowser. Öffnet sich im Browser. Eidovara erfasst keine Zugangsdaten, umgeht keine Abos, lädt keine geschützten Streams, bettet diese Player nicht ein und impliziert keine Partnerschaft.',
      sessionLibrary: 'Lokale Bibliothek dieser Sitzung', discoveryTitle: 'Letzte Entdeckung', playInEidovara: 'In Eidovara abspielen', playLocal: 'Abspielen', emptyLibrary: 'Öffnen Sie eine lokale Audio- oder Videodatei zur Wiedergabe in Eidovara. Pfade stehen nicht in den Geschmacksdaten.', emptyDiscovery: 'Bitten Sie um Musik, ein Video oder einen Mix, um lokale Treffer und offizielle YouTube-/Spotify-/Archive-Suchen zu sehen.',
      openLocalMedia: 'Lokale Medien öffnen',
      playerStageTitle: 'Eidovara-Player', playerCollapse: 'Player einklappen', playerExpand: 'Player erweitern',
      playerSeek: 'Position', playerVolume: 'Lautstärke', playerPlay: 'Wiedergabe', playerPause: 'Pause', playerNothing: 'Nichts wird abgespielt',
      playerQueue: 'Als Nächstes', playerRecents: 'Zuletzt auf diesem Gerät', playerLyricsHeading: 'Liedtext',
      playerLyrics: 'Keine lizenzierten Liedtexte in der App', playerLocalFile: 'Lokale Datei', playerLocalVideo: 'Lokales Video',
      playerVideo: 'Video', playerAudio: 'Audio', playerSpotify: 'Spotify-Suche', playerYouTube: 'YouTube-Suche',
      playerHandoffConfirm: 'Öffnet sich im Browser. Eidovara spielt Spotify und YouTube nicht in der App ab.',
      playerBlockedSrc: 'Diese Quelle kann in Eidovara nicht wiedergegeben werden. Nutzen Sie eine lokale Datei oder eine öffentliche HTTPS-Quelle. Spotify und YouTube bleiben Browsersuchen.',
      companionNowPlaying: 'Läuft gerade', companionPause: 'Pause',
