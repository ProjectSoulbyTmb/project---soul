...
(() => {
  const messages = {
    en: {
      ...
      entertainmentTitle: 'Entertainment', entertainmentLead: 'Local taste, a workspace now-playing bar, and an isolated online viewing window — Spotify and YouTube stay official HTTPS pages in that guest window.',
      ...
      platformTitle: 'Platform connections', platformLead: 'Online viewing uses a separate window. The workspace itself stays offline-to-the-web. Spotify and YouTube open official HTTPS pages in that guest window. Eidovara does not capture credentials, bypass subscriptions, download protected streams, or imply affiliation.',
      ...
      researchIdle: 'no lookup yet', researchResults: 'Internet results', openInBrowser: 'Open in browser', openInGuest: 'Open in online window',
      researchLookup: 'Look up', researchTopicLabel: 'Topic or HTTPS page', dashResearch: 'Research', nextResearch: 'Open Research',
      handoffNote: 'Official HTTPS search in the online viewing window. Eidovara does not fetch that site’s HTML or capture logins in the workspace.',
    ...
    es: {
      ...
      entertainmentTitle: 'Entretenimiento', entertainmentLead: 'Gusto local, barra de reproducción y una ventana de visualización en línea aislada — Spotify y YouTube siguen siendo páginas HTTPS oficiales en esa ventana invitada.',
      ...
      platformTitle: 'Conexiones de plataforma', platformLead: 'La visualización en línea usa una ventana aparte. El espacio de trabajo sigue sin abrir la web. Spotify y YouTube abren páginas HTTPS oficiales en esa ventana invitada. Eidovara no captura credenciales, evita suscripciones, descarga streams protegidos ni implica afiliación.',
      ...
      researchIdle: 'sin consulta', researchResults: 'Resultados de internet', openInBrowser: 'Abrir en el navegador', openInGuest: 'Abrir en la ventana en línea',
      ...
      handoffNote: 'Búsqueda HTTPS oficial en la ventana de visualización en línea. Eidovara no descarga el HTML de ese sitio ni captura inicios de sesión en el espacio de trabajo.',
    ...
    fr: {
      ...
      entertainmentTitle: 'Divertissement', entertainmentLead: 'Goût local, barre de lecture et fenêtre de visionnage en ligne isolée — Spotify et YouTube restent des pages HTTPS officielles dans cette fenêtre invitée.',
      ...
      platformTitle: 'Connexions de plateformes', platformLead: 'Le visionnage en ligne utilise une fenêtre séparée. L’espace de travail reste hors du web. Spotify et YouTube ouvrent des pages HTTPS officielles dans cette fenêtre invitée. Eidovara ne capture pas les identifiants, n’évite pas les abonnements, ne télécharge pas les flux protégés et n’implique aucune affiliation.',
      ...
      researchIdle: 'pas encore de recherche', researchResults: 'Résultats internet', openInBrowser: 'Ouvrir dans le navigateur', openInGuest: 'Ouvrir dans la fenêtre en ligne',
      researchLookup: 'Consulter', researchTopicLabel: 'Sujet ou page HTTPS', dashResearch: 'Recherche', nextResearch: 'Ouvrir Recherche',
      handoffNote: 'Recherche HTTPS officielle dans la fenêtre de visionnage en ligne. Eidovara ne récupère pas le HTML de ce site et ne capture pas les identifiants dans l’espace de travail.',
    ...
    de: {
      ...
      entertainmentTitle: 'Unterhaltung', entertainmentLead: 'Lokaler Geschmack, Now-Playing-Leiste und ein isoliertes Online-Fenster — Spotify und YouTube bleiben offizielle HTTPS-Seiten in diesem Gastfenster.',
      ...
      platformTitle: 'Plattformverbindungen', platformLead: 'Online-Ansicht nutzt ein separates Fenster. Der Workspace bleibt vom Web getrennt. Spotify und YouTube öffnen offizielle HTTPS-Seiten in diesem Gastfenster. Eidovara erfasst keine Zugangsdaten, umgeht keine Abos, lädt keine geschützten Streams und impliziert keine Partnerschaft.',
      ...
      researchIdle: 'noch keine Suche', researchResults: 'Internetergebnisse', openInBrowser: 'Im Browser öffnen', openInGuest: 'Im Online-Fenster öffnen',
      ...
      handoffNote: 'Offizielle HTTPS-Suche im Online-Fenster. Eidovara lädt das HTML dieser Seite nicht und erfasst keine Anmeldungen im Workspace.',
