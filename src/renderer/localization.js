...
(() => {
  const messages = {
    en: {
      ...
      entertainmentTitle: 'Entertainment', entertainmentLead: 'Local files play at native quality. Optional Online media plays public HTTPS audio/video you ask for. Spotify, YouTube, and Netflix open in your browser. Optional web guest loads HTTPS pages in an isolated window.',
      ...
      playOnline: 'Play HTTPS file',
      openGuest: 'Open in guest window',
      onlineMediaHelp: 'Off until you enable Online media in Settings. Direct HTTPS files only. No DRM catalogs in-process.',
      webGuestHelp: 'Off until you enable Web guest in Settings. Isolated sandboxed partition. Main workspace stays locked.',
      onlineMediaOff: 'Online media is off. Enable it in Settings to play a public HTTPS file.',
      catalogHandoff: 'This service can’t play inside Eidovara; it opens in your browser.',
    ...
    es: {
      ...
      entertainmentTitle: 'Entretenimiento', entertainmentLead: 'Los archivos locales se reproducen a calidad nativa. Los medios en línea opcionales reproducen audio/vídeo HTTPS público que pidas. Spotify, YouTube y Netflix se abren en el navegador. La ventana invitada opcional carga páginas HTTPS aisladas.',
      ...
      playOnline: 'Reproducir archivo HTTPS',
      openGuest: 'Abrir en ventana invitada',
      onlineMediaHelp: 'Desactivado hasta que actives Medios en línea en Configuración. Solo archivos HTTPS públicos. Sin catálogos DRM en el proceso.',
      webGuestHelp: 'Desactivado hasta que actives Ventana invitada en Configuración. Partición aislada. El espacio principal sigue bloqueado.',
      onlineMediaOff: 'Los medios en línea están desactivados. Actívalos en Configuración para reproducir un archivo HTTPS público.',
      catalogHandoff: 'Este servicio no puede reproducirse dentro de Eidovara; se abre en el navegador.',
    ...
    fr: {
      ...
      entertainmentTitle: 'Divertissement', entertainmentLead: 'Les fichiers locaux se lisent en qualité native. Les médias en ligne optionnels lisent l’audio/vidéo HTTPS public que vous demandez. Spotify, YouTube et Netflix s’ouvrent dans le navigateur. La fenêtre invitée optionnelle charge des pages HTTPS isolées.',
      ...
      playOnline: 'Lire un fichier HTTPS',
      openGuest: 'Ouvrir dans la fenêtre invitée',
      onlineMediaHelp: 'Désactivé jusqu’à ce que vous activiez Médias en ligne dans Paramètres. Fichiers HTTPS publics uniquement. Pas de catalogues DRM dans le processus.',
      webGuestHelp: 'Désactivé jusqu’à ce que vous activiez la fenêtre invitée dans Paramètres. Partition isolée. L’espace principal reste verrouillé.',
      onlineMediaOff: 'Les médias en ligne sont désactivés. Activez-les dans Paramètres pour lire un fichier HTTPS public.',
      catalogHandoff: 'Ce service ne peut pas être lu dans Eidovara ; il s’ouvre dans le navigateur.',
    ...
    de: {
      ...
      entertainmentTitle: 'Unterhaltung', entertainmentLead: 'Lokale Dateien spielen in nativer Qualität. Optionale Online-Medien spielen öffentliche HTTPS-Audio/Video-Dateien, die Sie anfordern. Spotify, YouTube und Netflix öffnen im Browser. Das optionale Gastfenster lädt isolierte HTTPS-Seiten.',
      ...
      playOnline: 'HTTPS-Datei abspielen',
      openGuest: 'Im Gastfenster öffnen',
      onlineMediaHelp: 'Aus, bis Sie Online-Medien in den Einstellungen einschalten. Nur öffentliche HTTPS-Dateien. Keine DRM-Kataloge im Prozess.',
      webGuestHelp: 'Aus, bis Sie das Gastfenster in den Einstellungen einschalten. Isolierte Partition. Der Hauptraum bleibt gesperrt.',
      onlineMediaOff: 'Online-Medien sind aus. Schalten Sie sie in den Einstellungen ein, um eine öffentliche HTTPS-Datei abzuspielen.',
      catalogHandoff: 'Dieser Dienst kann in Eidovara nicht wiedergegeben werden; er öffnet sich im Browser.',
  ...
  queueMicrotask(async () => {
    try {
      ...
      select.addEventListener('change', async () => {
        ...
        await window.soul.configureAssistant({ autonomy: state.assistant?.autonomy, initiativeEnabled: state.assistant?.initiativeEnabled, reflectionEnabled: state.assistant?.reflectionEnabled, responseLength: p.responseLength, tone: p.tone, focusMode: p.focusMode, accessibility: p.accessibility, language: select.value, webResearch: c.webResearch, mediaPlayback: c.mediaPlayback, onlineMedia: c.onlineMedia, webGuest: c.webGuest, memoryLearning: c.memoryLearning });
      });
    } catch {}
  });
})();
