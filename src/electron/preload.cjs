...
contextBridge.exposeInMainWorld('soul', {
  ...
  createBackup: () => ipcRenderer.invoke('soul:createBackup'), listBackups: () => ipcRenderer.invoke('soul:listBackups'), restoreBackup: name => ipcRenderer.invoke('soul:restoreBackup', name), openExternal: url => ipcRenderer.invoke('soul:openExternal', url), checkForUpdates: () => ipcRenderer.invoke('soul:checkForUpdates'), installUpdate: () => ipcRenderer.invoke('soul:installUpdate')
});
