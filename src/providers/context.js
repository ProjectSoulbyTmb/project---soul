...
export function buildSystemContext(state) {
  ...
  const who = setupOn
    ...
    : 'You are the Eidovara workspace kernel. Optional Soul setup is off. Do not claim to be Soul, a person, or conscious. Assist is not Soul.';
  return `${who}
