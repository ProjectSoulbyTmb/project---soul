...
export const ADULT_VOICE_PRESETS = Object.freeze([
  ...
  { id: 'breathy-fem', title: 'Breathy coach (feminine)', demand: 'Soft dirty-talk with space between words', gender: 'feminine', rate: 0.78, pitch: 1.05, intimacy: 86, match: /aria|jenny|emma|nancy|monica|catherine/i, preview: 'Thatâ€™s itâ€¦ wetterâ€¦ donâ€™t you dare come yet.' },
  ...
  { id: 'natural-fem-lead', title: 'Windows Natural feminine', demand: 'Highest-quality OS neural if present', gender: 'feminine', rate: 0.9, pitch: 1.02, intimacy: 72, match: /natural|neural/i, genderLock: 'feminine', preview: 'Iâ€™m the Adult Soul voice on this PC. Still software. Still going to talk you through it.' },
  { id: 'intimate-low-masc', title: 'Intimate low (masculine)', demand: 'Low, close, dirty', gender: 'masculine', rate: 0.82, pitch: 0.78, intimacy: 80, match: /guy|andrew|ryan|david|davis|george|mark/i, preview: 'Grip it. Slow. I want it wet. Donâ€™t rush the head.' },
  { id: 'dominant-masc', title: 'Dominant (masculine)', demand: 'Coach / countdown / orders', gender: 'masculine', rate: 0.92, pitch: 0.82, intimacy: 68, match: /guy|andrew|ryan|brian|jason|tony/i, preview: 'Stroke. Faster. Hold. You donâ€™t come until I say.' },
  { id: 'warm-aftercare-masc', title: 'Warm aftercare (masculine)', demand: 'Calm after climax', gender: 'masculine', rate: 0.86, pitch: 0.9, intimacy: 36, match: /andrew|david|james|george/i, preview: 'Thatâ€™s enough. Breathe. Youâ€™re done proving anything.' },
  ...
  { id: 'uk-bedroom-masc', title: 'UK bedroom (masculine)', demand: 'British OS voice when installed', gender: 'masculine', rate: 0.84, pitch: 0.8, intimacy: 74, match: /george|ryan.*uk|en-gb|united kingdom/i, preview: 'Nice and slow. Let it throb. Iâ€™ve got you.' },
  { id: 'natural-masc-lead', title: 'Windows Natural masculine', demand: 'Highest-quality OS neural if present', gender: 'masculine', rate: 0.88, pitch: 0.84, intimacy: 72, match: /natural|neural/i, genderLock: 'masculine', preview: 'Adult Soul, still a program. Iâ€™ll talk you through the strokes anyway.' },
  { id: 'androgynous-even', title: 'Even / androgynous', demand: 'Mid pitch, less gendered', gender: 'androgynous', rate: 0.9, pitch: 1.0, intimacy: 58, match: /./, preview: 'Keep a steady hand. Tell me when youâ€™re close. I will back you off.' },
  { id: 'es-intimate', title: 'Spanish intimate', demand: 'es-* OS voices when installed', gender: 'any', rate: 0.86, pitch: 1.0, intimacy: 70, lang: /^es\b/i, preview: 'Despacio. MÃ¡s mojado. No te corras todavÃ­a.' },
  ...
  { id: 'de-intimate', title: 'German intimate', demand: 'de-* OS voices when installed', gender: 'any', rate: 0.86, pitch: 0.94, intimacy: 68, lang: /^de\b/i, preview: 'Langsamer. Fester. Komm nicht, bevor ich zÃ¤hle.' },
  { id: 'stroke-metronome', title: 'Stroke metronome', demand: 'Clear counting for jerk-off pace', gender: 'any', rate: 0.95, pitch: 0.96, intimacy: 50, match: /natural|neural|aria|guy|david|zira/i, preview: 'One. Two. Three. Squeeze. Four. Five. Donâ€™t finish.' },
  { id: 'edge-whisper', title: 'Edge whisper', demand: 'Very slow, almost whispered coaching', gender: 'any', rate: 0.72, pitch: 0.9, intimacy: 92, match: /aria|jenny|andrew|guy|natural/i, preview: 'Stop. Squeeze. Let it pulse. Youâ€™re not allowed to come.' },
  ...
  { id: 'hands-free-bed', title: 'Hands-free bed', demand: 'Longer phrases while user audio plays', gender: 'any', rate: 0.8, pitch: 0.98, intimacy: 84, match: /natural|neural|aria|jenny|andrew/i, preview: 'Listen. Touch if you want. Iâ€™ll keep talking until you stop me.' },
...
export function groupVoicesForPicker(voices) {
  ...
  return [...groups.entries()].map(([key, items]) => ({
    key,
    label: items[0]?.quality === 'os-neural' ? `Windows Natural / Neural Â· ${items[0].lang || ''}` : `Installed OS voices Â· ${items[0]?.lang || ''}`,
    items
  }));
}
