...
export class SoulEngine {
  ...
  async respond(input, extra = {}) {
    ...
    this.store.save(this.state);
    return { at: done, input: text, reply, policyEvents, learning, relationship, safetyReport, providerError, internetError, webResearch, kernel: meta, adultAllowed: adultAllowed(this.state), state: this.snapshot() };
  }
}
