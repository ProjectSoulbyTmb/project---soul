...
export const GAMEPAD_HONESTY =
  'A connected Chromium-visible gamepad can steer this pad and dual-rumble that same controller. That is the Gamepad API â€” not Lovense, not XInput injection into a game, and not in-game haptics.';
...
export const WELLNESS_CARDS = Object.freeze([
  ...
  },
  {
    id: 'privacy',
    title: 'Discreet lock',
    body: 'A 4â€“8 digit PIN blanks Adult Soul and Adult Media on this PC. Not Windows Hello, not a vendor cloud lock.',
  },
  {
    id: 'hardware',
