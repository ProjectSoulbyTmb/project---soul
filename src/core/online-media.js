...
export const HLS_UNSUPPORTED_COPY = 'HLS playlists are not played in-app. Desktop Chromium does not decode MPEG-TS HLS, and Eidovara does not load an HLS or Shaka library from a CDN.';
