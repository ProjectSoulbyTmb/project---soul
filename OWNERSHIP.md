...
This file is a **project record**, not a court judgment, signed assignment, government registration, or counsel opinion. **It is not legal advice.** A GitHub commit cannot make someone â€œsafelyâ€ the owner of another partyâ€™s software or of user content.
...
Eidovara is a trademark of Soul Consciousness Studios (unregistered). Soul (the software self-model feature name) and Soul Consciousness Studios (intended publisher name) are likewise claimed **unregistered** marks (`â„¢` only where used). This repository does **not** claim Â®, a USPTO registration number, a U.S. Copyright Office registration, or any patent / â€œpatent pending.â€ Enhancement of trademark or copyright protection requires qualified counsel and actual filings. See [TRADEMARKS.md](TRADEMARKS.md), [docs/TRADEMARK_FILING.md](docs/TRADEMARK_FILING.md) (not filed by this repository), and [docs/COPYRIGHT.md](docs/COPYRIGHT.md).
...
- Wikipedia/Wikimedia content (those projectsâ€™ licenses continue to apply);
...
Repository notices, LICENSE, TERMS, provenance hashes, and git history are evidence of a claimâ€”not a substitute for:
...
6. Patent counsel before any â€œpatent pendingâ€ statement.
