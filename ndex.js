...
export default {
  ...
  async watch(repo, events, _notify) {
    validateRepo(repo);
  ...
  async onPROpened(_payload) {},
  async onPRReviewRequested(_payload) {},
  async onIssueAssigned(_payload) {},
  async onWorkflowFailed(_payload) {}
};
