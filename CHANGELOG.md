...
- Source **v0.22.2** revised release incorporating website marks/wallpapers, security/licensing completeness, and honest online-status heartbeat. Live advertised Windows installer remains **v0.19.1** `Eidovara-0.19.1-Windows-x64-Setup.exe` SHA-256 `72F4D09ADA17593F0391438A5375ABC9351041DA8ABB252E68271B8FDACCA7D8` until a newer tagged Setup.exe exists. Tags `v0.18.0`–`v0.19.1` were not moved. No invented installer hash.
