...
- Public site ships high-resolution first-party website display marks, light/dark/product wallpapers, and an Open Graph image (`docs/eidovara-mark.png`, `docs/soul-consciousness-studios-mark.png`, `docs/eidovara-wallpaper-*.jpg`, `docs/eidovara-og.png`). Favicon stays the registered 512 rendition. Registered application masters in `assets/branding/` are unchanged. Live advertised installer remains **v0.19.1** `72F4D09ADA17593F0391438A5375ABC9351041DA8ABB252E68271B8FDACCA7D8`.
