...
- Persistent companion dock on the dashboard after 18+: heartbeat, presence, module chips, custom actions, keyboard-accessible, `prefers-reduced-motion`. Dashboard composer can ask the Worker helper for one send when opt-in is on.
